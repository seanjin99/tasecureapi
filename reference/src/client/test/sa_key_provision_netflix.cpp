...
#define netflix_encryption_key     "/keys/netflix_encryption_key.key"
...
namespace {
	...
	// Create a encryption key container
...
#ifdef FILE_BASED_FETCH_KEY
    // There are four file netflix_encryption_key, netflix_hmac_key.key,
    // netflix_wrapping_key.key and netflix_esn.bin
    // under tasecureapi/reference/test/,
    // these files are netflix encryption key, hmac and wrapping key and esn number. you can do
    // "export  netflix_encryption_key=~/PATH/tasecureapi/reference/test/netflix_encryption_key.key",
