    ...
    derivation_inputs_t export_derivation_inputs;
        ...
        .export_derivation_inputs = {
            .wrapping_key_inputs = {
               ...
               ,{0xcb, 0xf9, 0xa8, 0xb0, 0x17, 0x20, 0x0f, 0x1a, 0x83, 0xa4, 0xbf, 0x77, 0xd6, 0xd3, 0x23, 0x24}
...
#ifdef HS256_KEY_CONTAINER
               ,{0xce, 0x7b, 0xbe, 0x86, 0x5e, 0x07, 0xb6, 0xf3, 0x6c, 0x81, 0x74, 0xec, 0x50, 0x34, 0x23, 0x6b}
#endif //HS256_KEY_CONTAINER
            }
        }
        // clang-format on
