...
namespace {
    ...
    bool verify(
        ...
        if (!test_helpers_openssl::digest(hash, SA_DIGEST_ALGORITHM_SHA256, data, {}, {}))
            return false;
    ...
    TEST_P(TaProcessCommonEncryptionTest, nominal) {
        ...
        ASSERT_TRUE(test_helpers_openssl::digest(digest, SA_DIGEST_ALGORITHM_SHA256, sample_data.clear, {}, {}));
